      ...
      <div className="flex justify-center w-full min-h-[800px] bg-white p-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
          {blogCards.map((card, index) => (
            <div key={index} className="group relative w-full max-w-[300px] bg-gradient-to-r from-[#d8e3ee] to-[#d1e7f5] rounded-xl shadow-xl p-4 hover:shadow-2xl hover:shadow-gray-300 transition-all duration-300 m-3 transform hover:scale-105">
